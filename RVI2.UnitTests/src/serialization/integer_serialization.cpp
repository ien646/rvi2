...
namespace UnitTests
{
    ...
    public:
        TEST_METHOD(Test_SerializeInteger)
        {
            ...
            Assert::AreEqual(dataContainer[8], (U8)(u64 >> 8));
            Assert::AreEqual(dataContainer[9], (U8)(u64 >> 16));
            Assert::AreEqual(dataContainer[10], (U8)(u64 >> 24));
            Assert::AreEqual(dataContainer[11], (U8)(u64 >> 32));
